        ...
        btImport : function (options) {
            ...
            $(function () {
                ...
                layer.open({
                    ...
                    '<span class="margin20-l tips file-desc">' +
                    opts.fileDesc +
                    '</span>' +
                    ...
                    '数据校验中，请等待...' +
                    '<em class="gif-box">' +
                    '<img src="/static/pub/btImport/image/loading-circle.gif">' +
                    '</em>' +
                    '</div>' +
                    '<div class="bottom-btn-box">' +
                    ...
                    '<img src="/static/pub/btImport/image/icon-success.png" class="icon-success">' +
