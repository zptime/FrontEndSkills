        ...
        btImport : function (options) {
            ...
            var uploadExcelData = function (){
                ...
                $.ajax({
                    ...
                    error: function () {
                        $('#modal-import .mod-step-content .step-2 .waiting-box').css('display','none');//2019/2/15 zp 新增
                        $('#modal-import .error-box .error-data').html('请求超时');
                        $('#modal-import .error-box').css('display','block');//2019/2/15 zp 新增
                    }
                });
            };
            ...
            $(function () {
                ...
                layer.open({
                    ...
                    '数据校验中，请等待...' +
                    '<em class="gif-box">' +
                    '<img src="./image/loading-circle.gif">' +
                    '</em>' +
                    '</div>' +
                    '<div class="bottom-btn-box">' +
