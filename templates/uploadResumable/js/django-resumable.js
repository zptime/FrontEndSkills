var DjangoResumable = function (options) {
    ...
    defaults = {
        uploadUrl:'/api/upload/resumable',
    ...
    h_str +=
    '<form method="post" action="'+uploadUrl+'" class="upload-form">'+
         ...
         '<div class="upload-core-box" role="re-upload-show2">'+
            '<fieldset class="upload-fieldset">'+
                ...
                '<input id="'+reUploadId+'_inp" type="file" name="file" class="hidden" data-upload-url="'+uploadUrl+'"  multiple="multiple" >'+
            '</fieldset>'+
        '</div>'+
    '</form>';
    h_str +=
